...
public class ChessMatch {
	...
	private List<Piece> piecesOnTheBoard = new ArrayList<>(); // tanto faz instanciar a lista no construtor ou aqui
	...
	private void initialSetup() {
		...
		placeNewPiece('e', 8, new King(board, Color.BLACK, this)); // para funcionar, a posiçao do REI precisa ser a
																	// mesma coluna da do rei das brancas por causa do
																	// movimento especial CASTLING, que foi feito
																	// sem levar em consideraçao a cor das peças;
